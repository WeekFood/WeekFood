...
INSERT INTO `productos` (`id`, `categoria`, `nombre`, `descripcion`, `foto`, `destacado`, `precio`) VALUES
	...
	(4, 'Pollo', 'Pechuga a la plancha', 'Plato saludable, aprobado por Sergio Peinado.', 'pechuga-a-la-plancha.jpg', 1, 500),
	...
	(7, 'Menestras', 'Menestra de verduras', 'Con hortalizas recien cogidas del campo.', 'menestra-verduras-jamon.jpg', 0, 500),
	(8, 'Tortilla,Patatas', 'Tortilla de patata', 'Plato típico español.', 'tortilla-patata.jpg', 0, 550),
