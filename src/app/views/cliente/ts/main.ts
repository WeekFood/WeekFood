...
var vistas = {
    ...
    portada: {
        ...
        procesado: (datos) => { $(".l-distribucion__principal").html("<div class='c-principal'><div class='js-carrusel'></div><div class='c-principal__texto'>" + JSON.parse(datos)["Contenido"]) + "</div></div>" },
